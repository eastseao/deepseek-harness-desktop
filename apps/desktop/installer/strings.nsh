...
LangString INSTALLER_PATH_WRITABLE ${LANG_ENGLISH} "This location is not writable. Choose a writable folder."
LangString INSTALLER_PATH_WRITABLE ${LANG_SIMPCHINESE} "无法写入此位置。请选择可写入的文件夹。"
...
LangString INSTALLER_MODE_ALL ${LANG_ENGLISH} "All users (requires administrator)"
LangString INSTALLER_MODE_ALL ${LANG_SIMPCHINESE} "所有用户（需要管理员权限）"
LangString INSTALLER_MODE_CURRENT ${LANG_ENGLISH} "Current user only"
LangString INSTALLER_MODE_CURRENT ${LANG_SIMPCHINESE} "仅当前用户"
LangString INSTALLER_ELEVATION ${LANG_ENGLISH} "Installing for all users requires administrator privileges. The system will ask for approval, then the installer reopens to continue."
LangString INSTALLER_ELEVATION ${LANG_SIMPCHINESE} "所有用户安装需要管理员权限。系统将弹出授权确认，随后安装程序会重新打开并继续安装。"
